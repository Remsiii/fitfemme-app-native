...
// add new property to the interface
...
export const onBoardingSlides: onBoardingSlidesTypes[] = [
  {
    ...
    secondTitle: "Comunitatea ta",
    subTitle: "Alătură-te comunității noastre de femei puternice și active",
    animate: true, // new property to trigger typewriter animation
  },
  {
    color: "#A7F893",
    title: "Stabilește-ți",
    ...
    secondTitle: "Obiectivele",
    subTitle: "Planifică-ți antrenamentele și atinge-ți scopurile cu aplicația noastră",
  },
  {
    color: "#FFC0CB",
    image: (
    ...
    title: "Transformă",
    secondTitle: "Corpul tău",
    subTitle: "Devino cea mai bună versiune a ta cu programele noastre de fitness",
  },
];
